...
(function(exports) {
  ...
  var SetGuess = (function () {
      function SetGuess(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetGuess.create = function (value0) {
          return function (value1) {
              return new SetGuess(value0, value1);
          };
      };
      return SetGuess;
  })();
  ...
  var status = function (v) {
      ...
      if (v instanceof Invalid) {
          return "Invalid. Guess must be an integer n where 0 <= n <= 99";
      };
  ...
  var inputToGuess = function ($37) {
      return Data_Int.fromString(Data_String.trim($37));
  };
  var initialState = function __do() {
      var v = Control_Monad_Eff_Random.randomInt(0)(100)();
      return {
          target: v, 
          guess: "", 
          attempts: Data_List_Types.Nil.value, 
          validAttempts: 0
      };
  };
  var cmp = function (n) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Main line 123, column 1 - line 127, column 24: " + [ n.constructor.name, m.constructor.name ]);
      };
  };
  var compareGuess = function (input) {
      return function (target) {
          return Data_Maybe.maybe(Invalid.value)(function (v) {
              return cmp(v)(target);
          })(inputToGuess(input));
      };
  };
  var isWinner = function (s) {
      var $17 = Data_List.head(s.attempts);
      if ($17 instanceof Data_Maybe.Nothing) {
          return false;
      };
      if ($17 instanceof Data_Maybe.Just) {
          return isEq(compareGuess($17.value0)(s.target));
      };
      throw new Error("Failed pattern match at Main line 107, column 14 - line 109, column 51: " + [ $17.constructor.name ]);
  };
  var $$eval = function (v) {
      if (v instanceof SetGuess) {
      ...
      if (v instanceof Guess) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
              ...
              if (!$25) {
                  ...
                  $27.attempts = new Data_List_Types.Cons(s.guess, s.attempts);
                  $27.validAttempts = (function () {
                      var $26 = isValid(compareGuess(s.guess)(s.target));
                      if ($26) {
                          return s.validAttempts + 1 | 0;
                      };
                      if (!$26) {
                          return s.validAttempts;
                      };
                      throw new Error("Failed pattern match at Main line 67, column 29 - line 67, column 117: " + [ $26.constructor.name ]);
                  })();
                  return $27;
              };
              throw new Error("Failed pattern match at Main line 65, column 14 - line 68, column 12: " + [ $25.constructor.name ]);
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
          });
      };
      if (v instanceof Restart) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(initialState))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v1))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          });
      };
      throw new Error("Failed pattern match at Main line 58, column 8 - line 75, column 14: " + [ v.constructor.name ]);
  };
  var render = function (s) {
      return Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Guess the number!") ]), Halogen_HTML_Elements.span_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(s.guess), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetGuess.create)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Guess.create)) ])([ Halogen_HTML_Core.text("Guess") ]) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Attempts: " + Data_Show.show(Data_Show.showInt)(s.validAttempts)) ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)((function () {
          var $33 = Data_List.head(s.attempts);
          if ($33 instanceof Data_Maybe.Nothing) {
              return [  ];
          };
          if ($33 instanceof Data_Maybe.Just) {
              return [ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Status:   " + status(compareGuess($33.value0)(s.target))) ]) ];
          };
          throw new Error("Failed pattern match at Main line 89, column 10 - line 91, column 94: " + [ $33.constructor.name ]);
      })())([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Restart.create)) ])([ Halogen_HTML_Core.text("Restart") ]) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("https://github.com/soupi/guess-num") ])([ Halogen_HTML_Core.text("View the code on Github") ]) ]) ])));
  };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(initialState))(function (v1) {
  ...
  exports["inputToGuess"] = inputToGuess;
  exports["isEq"] = isEq;
